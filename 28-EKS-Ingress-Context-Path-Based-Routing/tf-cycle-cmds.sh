...
file_path="/home/cloud_user/github/aws-eks-tf-50-demos/28-EKS-Ingress-Context-Path-Based-Routing/01-ekscluster-tf-manifests/private-key/$key_pair_name.pem"
