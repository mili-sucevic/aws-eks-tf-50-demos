...
file_path="/home/cloud_user/github/aws-eks-tf-50-demos/33-EKS-Ingress-Name-Based-Virtual-Host-Routing/01-ekscluster-tf-manifests/private-key/$key_pair_name.pem"
