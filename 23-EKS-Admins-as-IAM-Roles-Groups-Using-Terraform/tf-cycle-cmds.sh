...
file_path="/home/cloud_user/github/aws-eks-tf-50-demos/23-EKS-Admins-as-IAM-Roles-Groups-Using-Terraform/01-ekscluster-tf-manifests/private-key/$key_pair_name.pem"
