...
file_path="/home/cloud_user/github/aws-eks-tf-50-demos/24-EKS-ReadOnly-User-using-IAMRoles-Groups-k8s-CR-CRB/01-ekscluster-tf-manifests/private-key/$key_pair_name.pem"
